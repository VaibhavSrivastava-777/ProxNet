              ...
              <div key={s.user.id} className="card p-4 border border-[var(--color-accent)]/30 bg-[var(--color-accent)]/5 flex flex-col gap-3">
                <div className="flex gap-3 items-center">
                  <div className="avatar avatar-md">
                    <div className="w-10 h-10 rounded-full bg-[var(--color-surface-hover)] flex items-center justify-center text-primary">
                  ...
                  <div>
                    <div className="font-semibold">Nearby Professional</div>
