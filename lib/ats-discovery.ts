...
const KNOWN_BOARDS: Record<string, { provider: string; board: string }> = {
  ...
  "ey": { provider: "custom", board: "https://www.ey.com/en_in/careers" },
  "mckinsey": { provider: "custom", board: "https://www.mckinsey.com/careers" },
  "mckinsey and company": { provider: "custom", board: "https://www.mckinsey.com/careers" },
  ...
  "verint": { provider: "custom", board: "https://www.verint.com/careers/" },
  "verint systems": { provider: "custom", board: "https://www.verint.com/careers/" },
