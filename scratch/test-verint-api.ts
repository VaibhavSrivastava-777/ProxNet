async function test() {
  const url = "https://fa-epcb-saasfaprod1.fa.ocs.oraclecloud.com/hcmRestApi/resources/11.13.18.05/recruitingCEJobRequisitions?onlyData=true&finder=findReqs;siteNumber=CX&expand=requisitionList&limit=5";
  try {
