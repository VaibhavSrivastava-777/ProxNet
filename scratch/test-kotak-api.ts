async function test() {
  const url = "https://eggh.fa.em2.oraclecloud.com/hcmRestApi/resources/11.13.18.05/recruitingCEJobRequisitions?onlyData=true&finder=findReqs;siteNumber=CX_1&expand=requisitionList&limit=5";
  try {
